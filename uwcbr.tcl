########################################################################################
# ----------------------------------------------------------------------------------
# This script depicts a very simple but complete stack in which several nodes send data
# to a common sink.
...
proc finish {} {
    ...
    for {set i 0} {$i < $opt(nn)} {incr i}  {
        ...
        set throughput_efficency [expr $cbr_rcv_pkts - 4 - $opt(profile_overhead)]
